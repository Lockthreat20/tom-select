...
*/
!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t(require("@orchidjs/sifter/lib/utils")):"function"==typeof define&&define.amd?define(["@orchidjs/sifter/lib/utils"],t):(e="undefined"!=typeof globalThis?globalThis:e||self).TomSelect=t(e.utils)}(this,(function(e){"use strict"
function t(e,t){e.split(/\s+/).forEach((e=>{t(e)}))}class i{constructor(){this._events=void 0,this._events={}}on(e,i){t(e,(e=>{const t=this._events[e]||[]
t.push(i),this._events[e]=t}))}off(e,i){var s=arguments.length
0!==s?t(e,(e=>{if(1===s)return void delete this._events[e]
const t=this._events[e]
void 0!==t&&(t.splice(t.indexOf(i),1),this._events[e]=t)})):this._events={}}trigger(e,...i){var s=this
t(e,(e=>{const t=s._events[e]
void 0!==t&&t.forEach((e=>{e.apply(s,i)}))}))}}const s=e=>(e=e.filter(Boolean)).length<2?e[0]||"":1==a(e)?"["+e.join("")+"]":"(?:"+e.join("|")+")",n=e=>{if(!r(e))return e.join("")
let t="",i=0
const s=()=>{i>1&&(t+="{"+i+"}")}
return e.forEach(((n,o)=>{n!==e[o-1]?(s(),t+=n,i=1):i++})),s(),t},o=e=>{let t=Array.from(e)
return s(t)},r=e=>new Set(e).size!==e.length,l=e=>(e+"").replace(/([\$\(\)\*\+\.\?\[\]\^\{\|\}\\])/gu,"\\$1"),a=e=>e.reduce(((e,t)=>Math.max(e,c(t))),0),c=e=>Array.from(e).length,d=e=>{if(1===e.length)return[[e]]
let t=[]
...
g[s]=e}}const v=new RegExp(Object.keys(g).join("|")+"|[̀-ͯ·ʾʼ]","gu"),m=(e,t="NFKD")=>e.normalize(t),y=e=>Array.from(e).reduce(((e,t)=>e+O(t)),""),O=e=>(e=m(e).toLowerCase().replace(v,(e=>g[e]||"")),m(e,"NFC"))
const b=e=>{const t={},i=(e,i)=>{const s=t[e]||new Set,n=new RegExp("^"+o(s)+"$","iu")
...
return t},w=e=>{const t=b(e),i={}
let n=[]
for(let e in t){let s=t[e]
s&&(i[e]=o(s)),e.length>1&&n.push(l(e))}n.sort(((e,t)=>t.length-e.length))
const r=s(n)
return h=new RegExp("^"+r,"u"),i},_=(e,t=1)=>(t=Math.max(t,e.length-1),s(d(e).map((e=>((e,t=1)=>{let i=0
return e=e.map((e=>(p[e]&&(i+=e.length),p[e]||e))),i>=t?n(e):""})(e,t))))),S=(e,t=!0)=>{let i=e.length>1?1:0
return s(e.map((e=>{let s=[]
const o=t?e.length():e.length()-1
for(let t=0;t<o;t++)s.push(_(e.substrs[t]||"",i))
return n(s)})))},C=(e,t)=>{for(const i of t){if(i.start!=e.start||i.end!=e.end)continue
...
constructor(){this.parts=[],this.substrs=[],this.start=0,this.end=0}add(e){e&&(this.parts.push(e),this.substrs.push(e.substr),this.start=Math.min(e.start,this.start),this.end=Math.max(e.end,this.end))}last(){return this.parts[this.parts.length-1]}length(){return this.parts.length}clone(e,t){let i=new I,s=JSON.parse(JSON.stringify(this.parts)),n=s.pop()
...
for(let e of l)C(e,i)||i.push(e)}else if(s>0&&1==a.size&&!a.has("3")){t+=S(i,!1)
let e=new I
const s=i[0]
s&&e.add(s.last()),i=[e]}}return t+=S(i,!0),t},x=(e,t)=>{if(e)return e[t]},k=(e,t)=>{if(e){for(var i,s=t.split(".");(i=s.shift())&&(e=e[i]););return e}},F=(e,t,i)=>{var s,n
...
const s=[],n=e.split(/\s+/)
var o
return i&&(o=new RegExp("^("+Object.keys(i).map(l).join("|")+"):(.*)$")),n.forEach((e=>{let i,n=null,r=null
o&&(i=e.match(o))&&(n=i[1],e=i[2]),e.length>0&&(r=this.settings.diacritics?A(e)||null:l(e),r&&t&&(r="\\b"+r)),s.push({string:e,regex:r?new RegExp(r,"iu"):null,field:n})})),s}getScoreFunction(e,t){var i=this.prepareSearch(e,t)
...
return r&&s.items.sort(r),s.total=s.items.length,"number"==typeof t.limit&&(s.items=s.items.slice(0,t.limit)),s}}const N=e=>{if(e.jquery)return e[0]
if(e instanceof HTMLElement)return e
if(j(e)){var t=document.createElement("template")
return t.innerHTML=e.trim(),t.content.firstChild}return document.querySelector(e)},j=e=>"string"==typeof e&&e.indexOf("<")>-1,$=(e,t)=>{var i=document.createEvent("HTMLEvents")
i.initEvent(t,!0,!1),e.dispatchEvent(i)},q=(e,t)=>{Object.assign(e.style,t)},V=(e,...t)=>{var i=R(t);(e=H(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))},D=(e,...t)=>{var i=R(t);(e=H(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))},R=t=>{var i=[]
return e.iterate(t,(e=>{"string"==typeof e&&(e=e.trim().split(/[\11\12\14\15\40]/)),Array.isArray(e)&&(i=i.concat(e))})),i.filter(Boolean)},H=e=>(Array.isArray(e)||(e=[e]),e),M=(e,t,i)=>{if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
e=e.parentNode}},z=(e,t=0)=>t>0?e[e.length-1]:e[0],B=(e,t)=>{if(!e)return-1
t=t||e.nodeName
for(var i=0;e=e.previousElementSibling;)e.matches(t)&&i++
return i},K=(t,i)=>{e.iterate(i,((e,i)=>{null==e?t.removeAttribute(i):t.setAttribute(i,""+e)}))},Q=(e,t)=>{e.parentNode&&e.parentNode.replaceChild(t,e)},G=(e,t)=>{if(null===t)return
...
function le(t,i){var s=Object.assign({},J,i),n=s.dataAttr,o=s.labelField,r=s.valueField,l=s.disabledField,a=s.optgroupField,c=s.optgroupLabelField,d=s.optgroupValueField,u=t.tagName.toLowerCase(),p=t.getAttribute("placeholder")||t.getAttribute("data-placeholder")
if(!p&&!s.allowEmptyOption){let e=t.querySelector('option[value=""]')
e&&(p=e.textContent)}var h={placeholder:p,options:[],optgroups:[],items:[],maxItems:null}
return"select"===u?(()=>{var i,u=h.options,p={},g=1
let f=0
var v=e=>{var t=Object.assign({},e.dataset),i=n&&t[n]
return"string"==typeof i&&i.length&&(t=Object.assign(t,JSON.parse(i))),t},m=(e,t)=>{var i=W(e.value)
if(null!=i&&(i||s.allowEmptyOption)){if(p.hasOwnProperty(i)){if(t){var n=p[i][a]
n?Array.isArray(n)?n.push(t):p[i][a]=[n,t]:p[i][a]=t}}else{var c=v(e)
c[o]=c[o]||e.textContent,c[r]=c[r]||i,c[l]=c[l]||e.disabled,c[a]=c[a]||t,c.$option=e,c.$order=c.$order||++f,p[i]=c,u.push(c)}e.selected&&h.items.push(i)}}
h.maxItems=t.hasAttribute("multiple")?null:1,e.iterate(t.children,(t=>{var s,n,o
"optgroup"===(i=t.tagName.toLowerCase())?((o=v(s=t))[c]=o[c]||s.getAttribute("label")||"",o[d]=o[d]||g++,o[l]=o[l]||s.disabled,o.$order=o.$order||++f,h.optgroups.push(o),n=o[d],e.iterate(s.children,(e=>{m(e,n)}))):"option"===i&&m(t)}))})():(()=>{const i=t.getAttribute(n)
if(i)h.options=JSON.parse(i),e.iterate(h.options,(e=>{h.items.push(e[r])}))
else{var l=t.value.trim()||""
if(!s.allowEmptyOption&&!l.length)return
const i=l.split(s.delimiter)
e.iterate(i,(e=>{const t={}
t[o]=e,t[r]=e,h.options.push(t)})),h.items=i}})(),Object.assign({},J,h,i)}var ae=0
...
t.loadPlugin(e)}return i.loaded[e]}}}(i)){constructor(e,t){var i
...
const n=le(s,t)
this.settings=n,this.input=s,this.tabIndex=s.tabIndex||0,this.is_select_tag="select"===s.tagName.toLowerCase(),this.rtl=/rtl/i.test(i),this.inputId=ne(s,"tomselect-"+ae),this.isRequired=s.required,this.sifter=new P(this.options,{diacritics:n.diacritics}),n.mode=n.mode||(1===n.maxItems?"single":"multi"),"boolean"!=typeof n.hideSelected&&(n.hideSelected="multi"===n.mode),"boolean"!=typeof n.hidePlaceholder&&(n.hidePlaceholder="multi"!==n.mode)
...
var p
if(V(r,n.wrapperClass,d,u),V(l,n.controlClass),re(r,l),V(a,n.dropdownClass,u),n.copyClassesToDropdown&&V(a,d),V(c,n.dropdownContentClass),re(a,c),N(n.dropdownParent||r).appendChild(a),j(n.controlInput)){p=N(n.controlInput)
E(["autocorrect","autocapitalize","autocomplete","spellcheck"],(e=>{s.getAttribute(e)&&K(p,{[e]:s.getAttribute(e)})})),p.tabIndex=-1,l.appendChild(p),this.focus_node=p}else n.controlInput?(p=N(n.controlInput),this.focus_node=p):(p=N("<input/>"),this.focus_node=l)
this.wrapper=r,this.dropdown=a,this.dropdown_content=c,this.control=l,this.control_input=p,this.setup()}setup(){const e=this,t=e.settings,i=e.control_input,s=e.dropdown,n=e.dropdown_content,o=e.wrapper,r=e.control,a=e.input,c=e.focus_node,d={passive:!0},u=e.inputId+"-ts-dropdown"
...
V([o,s],t)}(null===t.maxItems||t.maxItems>1)&&e.is_select_tag&&K(a,{multiple:"multiple"}),t.placeholder&&K(i,{placeholder:t.placeholder}),!t.splitOn&&t.delimiter&&(t.splitOn=new RegExp("\\s*"+l(t.delimiter)+"+\\s*")),t.load&&t.loadThrottle&&(t.load=Z(t.load,t.loadThrottle)),ie(s,"mousemove",(()=>{e.ignoreHover=!1})),ie(s,"mouseenter",(t=>{var i=M(t.target,"[data-selectable]",s)
i&&e.onOptionHover(t,i)}),{capture:!0}),ie(s,"click",(t=>{const i=M(t.target,"[data-selectable]")
i&&(e.onOptionSelect(t,i),te(t,!0))})),ie(r,"click",(t=>{var s=M(t.target,"[data-ts-item]",r)
s&&e.onItemSelect(t,s)?te(t,!0):""==i.value&&(e.onClick(),te(t,!0))})),ie(c,"keydown",(t=>e.onKeyDown(t))),ie(i,"keypress",(t=>e.onKeyPress(t))),ie(i,"input",(t=>e.onInput(t))),ie(c,"blur",(t=>e.onBlur(t))),ie(c,"focus",(t=>e.onFocus(t))),ie(i,"paste",(t=>e.onPaste(t)))
const v=t=>{const n=t.composedPath()[0]
if(!o.contains(n)&&!s.contains(n))return e.isFocused&&e.blur(),void e.inputState()
n==i&&e.isOpen?t.stopPropagation():te(t,!0)},m=()=>{e.isOpen&&e.positionDropdown()}
ie(document,"mousedown",v),ie(window,"scroll",m,d),ie(window,"resize",m,d),this._destroy=()=>{document.removeEventListener("mousedown",v),window.removeEventListener("scroll",m),window.removeEventListener("resize",m),g&&g.removeEventListener("click",f)},this.revertSettings={innerHTML:a.innerHTML,tabIndex:a.tabIndex},a.tabIndex=-1,a.insertAdjacentElement("afterend",e.wrapper),e.sync(!1),t.items=[],delete t.optgroups,delete t.options,ie(a,"invalid",(()=>{e.isValid&&(e.isValid=!1,e.isInvalid=!0,e.refreshState())})),e.updateOriginalInput(),e.refreshItems(),e.close(!1),e.inputState(),e.isSetup=!0,a.disabled?e.disable():a.readOnly?e.setReadOnly(!0):e.enable(),e.on("change",this.onChange),V(a,"tomselected","ts-hidden-accessible"),e.trigger("initialize"),!0===t.preload&&e.preload()}setupOptions(e=[],t=[]){this.addOptions(e),E(t,(e=>{this.registerOptionGroup(e)}))}setupTemplates(){var e=this,t=e.settings.labelField,i=e.settings.optgroupLabelField,s={optgroup:e=>{let t=document.createElement("div")
...
e.isFocused&&e.isOpen?e.blur():e.focus()}onMouseDown(){}onChange(){$(this.input,"input"),$(this.input,"change")}onPaste(e){var t=this
t.isInputHidden||t.isLocked?te(e):t.settings.splitOn&&setTimeout((()=>{var e=t.inputValue()
if(e.match(t.settings.splitOn)){var i=e.trim().split(t.settings.splitOn)
E(i,(e=>{W(e)&&(this.options[e]?t.addItem(e):t.createItem(e))}))}}),0)}onKeyPress(e){var t=this
...
case 8:case 46:return void t.deleteSelection(e)}t.isInputHidden&&!se(U,e)&&te(e)}}onInput(e){if(this.isLocked)return
...
if(t.isDisabled||t.isReadOnly)return t.blur(),void te(e)
...
t.parentElement&&t.parentElement.matches("[data-disabled]")||(t.classList.contains("create")?s.createItem(null,(()=>{s.settings.closeAfterSelect&&s.close()})):void 0!==(i=t.dataset.value)&&(s.addItem(i),s.settings.closeAfterSelect&&s.close(),!s.settings.hideSelected&&e.type&&/click/.test(e.type)&&s.setActiveOption(t)))}canSelect(e){return!!(this.isOpen&&e&&this.dropdown_content.contains(e))}onItemSelect(e,t){var i=this
...
i.loading=Math.max(i.loading-1,0),i.lastQuery=null,i.clearActiveOption(),i.setupOptions(e,t),i.refreshOptions(i.isFocused&&!i.isInputHidden),i.loading||D(i.wrapper,i.settings.loadingClass),i.trigger("load",e,t)}preload(){var e=this.wrapper.classList
e.contains("preloaded")||(e.add("preloaded"),this.load(""))}setTextboxValue(e=""){var t=this.control_input
t.value!==e&&(t.value=e,$(t,"update"),this.lastValue=e)}getValue(){return this.is_select_tag&&this.input.hasAttribute("multiple")?this.items:this.items.join(this.settings.delimiter)}setValue(e,t){ee(this,t?[]:["change"],(()=>{this.clear(t),this.addItems(e,t)}))}setMaxItems(e){0===e&&(e=null),this.settings.maxItems=e,this.refreshState()}setActiveItem(e,t){var i,s,n,o,r,l,a=this
...
i&&D(i,"last-active"),V(e,"active last-active"),t.trigger("item_select",e),-1==t.activeItems.indexOf(e)&&t.activeItems.push(e)}removeActiveItem(e){var t=this.activeItems.indexOf(e)
this.activeItems.splice(t,1),D(e,"active")}clearActiveItems(){D(this.activeItems,"active"),this.activeItems=[]}setActiveOption(e,t=!0){e!==this.activeOption&&(this.clearActiveOption(),e&&(this.activeOption=e,K(this.focus_node,{"aria-activedescendant":e.getAttribute("id")}),K(e,{"aria-selected":"true"}),V(e,"active"),t&&this.scrollToOption(e)))}scrollToOption(e,t){if(!e)return
const i=this.dropdown_content,s=i.clientHeight,n=i.scrollTop||0,o=e.offsetHeight,r=e.getBoundingClientRect().top-i.getBoundingClientRect().top+n
r+o>s+n?this.scroll(r-s+o,t):r<n&&this.scroll(r,t)}scroll(e,t){const i=this.dropdown_content
t&&(i.style.scrollBehavior=t),i.scrollTop=e,i.style.scrollBehavior=""}clearActiveOption(){this.activeOption&&(D(this.activeOption,"active"),K(this.activeOption,{"aria-selected":null})),this.activeOption=null,K(this.focus_node,{"aria-activedescendant":null})}selectAll(){const e=this
if("single"===e.settings.mode)return
const t=e.controlChildren()
t.length&&(e.inputState(),e.close(),e.activeItems=t,E(t,(t=>{e.setActiveItemClass(t)})))}inputState(){var e=this
e.control.contains(e.control_input)&&(K(e.control_input,{placeholder:e.settings.placeholder}),e.activeItems.length>0||!e.isFocused&&e.settings.hidePlaceholder&&e.items.length>0?(e.setTextboxValue(),e.isInputHidden=!0):(e.settings.hidePlaceholder&&e.items.length>0&&K(e.control_input,{placeholder:""}),e.isInputHidden=!1),e.wrapper.classList.toggle("input-hidden",e.isInputHidden))}inputValue(){return this.control_input.value.trim()}focus(){var e=this
...
const[s,a]=b(o,e)
i>0&&(d=d.cloneNode(!0),K(d,{id:l.$id+"-clone-"+i,"aria-selected":null}),d.classList.add("ts-cloned"),D(d,"active"),h.activeOption&&h.activeOption.dataset.value==n&&c&&c.dataset.group===o.toString()&&(m=d)),a.appendChild(d),""!=o&&(u[o]=s)}}var w
...
re(l,n)}else re(l,t)})),O.innerHTML="",re(O,l),h.settings.highlight&&(w=O.querySelectorAll("span.highlight"),Array.prototype.forEach.call(w,(function(e){var t=e.parentNode
t.replaceChild(e.firstChild,e),t.normalize()})),v.query.length&&v.tokens.length&&E(v.tokens,(e=>{G(O,e.regex)})))
...
Q(a,e),i.activeOption===a&&i.setActiveOption(e)}a.remove()}c&&(-1!==(n=i.items.indexOf(o))&&i.items.splice(n,1,r),s=i._render("item",t),c.classList.contains("active")&&V(s,"active"),Q(c,s)),i.lastQuery=null}removeOption(e,t){const i=this
...
const i={}
E(this.options,((e,s)=>{t(e,s)&&(i[s]=e)})),this.options=this.sifter.items=i,this.lastQuery=null,this.trigger("option_clear")}clearFilter(e,t){return this.items.indexOf(t)>=0}getOption(e,t=!1){const i=W(e)
...
t&&n.setActiveOption(t)}n.isPending||n.settings.closeAfterSelect||n.settings.hideSelected||n.getOption(r).classList.toggle("selected",n.items.includes(r)),0!=n.settings.closeAfterSelect&&n.isFull()?n.close():n.isPending||n.positionDropdown(),n.trigger("item_add",r,i),n.isPending||n.updateOriginalInput({silent:t})}(!n.isPending||!s&&n.isFull())&&(n.inputState(),n.refreshState())}}))}removeItem(e=null,t){const i=this
if(!(e=i.getItem(e)))return
var s,n
const o=e.dataset.value
s=B(e),e.remove(),e.classList.contains("active")&&(n=i.activeItems.indexOf(e),i.activeItems.splice(n,1),D(e,"active")),i.items.splice(s,1),!i.settings.persist&&i.userOptions.hasOwnProperty(o)&&i.removeOption(o,t),s<i.caretPos&&i.setCaret(i.caretPos-1),i.updateOriginalInput({silent:t}),i.refreshState(),i.positionDropdown(),i.trigger("item_remove",o,e)}createItem(e=null,t=()=>{}){3===arguments.length&&(t=arguments[2]),"function"!=typeof t&&(t=()=>{})
...
e&&(t.setTextboxValue(),"single"===t.settings.mode&&t.items.length&&t.inputState()),t.isOpen=!1,K(t.focus_node,{"aria-expanded":"false"}),q(t.dropdown,{display:"none"}),t.settings.hideSelected&&t.clearActiveOption(),t.refreshState(),i&&t.trigger("dropdown_close",t.dropdown)}positionDropdown(){if("body"===this.settings.dropdownParent){var e=this.control,t=e.getBoundingClientRect(),i=e.offsetHeight+t.top+window.scrollY,s=t.left+window.scrollX
...
const l=[]
if(r.activeItems.length)n=z(r.activeItems,t),s=B(n),t>0&&s++,E(r.activeItems,(e=>l.push(e)))
...
return i?z(i,e):void 0}setCaret(e){this.caretPos=this.items.length}controlChildren(){return Array.from(this.control.querySelectorAll("[data-ts-item]"))}lock(){this.setLocked(!0)}unlock(){this.setLocked(!1)}setLocked(e=this.isReadOnly||this.isDisabled){this.isLocked=e,this.refreshState()}disable(){this.setDisabled(!0),this.close()}enable(){this.setDisabled(!1)}setDisabled(e){this.focus_node.tabIndex=e?-1:this.tabIndex,this.isDisabled=e,this.input.disabled=e,this.control_input.disabled=e,this.setLocked()}setReadOnly(e){this.isReadOnly=e,this.input.readOnly=e,this.control_input.readOnly=e,this.setLocked()}destroy(){var e=this,t=e.revertSettings
e.trigger("destroy"),e.off(),e.wrapper.remove(),e.dropdown.remove(),e.input.innerHTML=t.innerHTML,e.input.tabIndex=t.tabIndex,D(e.input,"tomselected","ts-hidden-accessible"),e._destroy(),delete e.input.tomselect}render(e,t){var i,s
const n=this
if("function"!=typeof this.settings.render[e])return null
if(!(s=n.settings.render[e].call(this,t,Y)))return null
if(s=N(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?K(s,{"aria-disabled":"true"}):K(s,{"data-selectable":""}):"optgroup"===e&&(i=t.group[n.settings.optgroupValueField],K(s,{"data-group":i}),t.group[n.settings.disabledField]&&K(s,{"data-disabled":""})),"option"===e||"item"===e){const i=X(t[n.settings.valueField])
K(s,{"data-value":i}),"item"===e?(V(s,n.settings.itemClass),K(s,{"data-ts-item":""})):(V(s,n.settings.optionClass),K(s,{role:"option",id:t.$id}),t.$div=s,n.options[i]=t)}return s}_render(e,t){const i=this.render(e,t)
...
return"after"===e&&(t=n.apply(s,arguments)),o=i.apply(s,arguments),"instead"===e?o:("before"===e&&(t=n.apply(s,arguments)),t)}}}return ce.define("change_listener",(function(){ie(this.input,"change",(()=>{this.sync()}))})),ce.define("checkbox_options",(function(e){var t=this,i=t.onOptionSelect
...
s.className&&l.classList.add(s.className),l.addEventListener("click",(function(e){te(e)})),l.type="checkbox"
const a=W(i[t.settings.valueField])
...
i&&o(i)})),t.hook("instead","onOptionSelect",((e,s)=>{if(s.classList.contains("selected"))return s.classList.remove("selected"),t.removeItem(s.dataset.value),t.refreshOptions(),void te(e,!0)
...
e.settings.render.item=(i,o)=>{const r=N(t.call(e,i,o))
K(r,{draggable:"true"})
...
return ie(r,"mousedown",(e=>{n||te(e),e.stopPropagation()})),ie(r,"dragstart",(e=>{s=r,setTimeout((()=>{r.classList.add("ts-dragging")}),0)})),ie(r,"dragenter",l),ie(r,"dragover",l),ie(r,"dragleave",(()=>{r.classList.remove("ts-drag-over")})),ie(r,"dragend",(()=>{var t
...
if(i){const s=B(i)
e.setCaret(t>0?s+1:s),e.setActiveItem(),D(i,"last-active")}else e.setCaret(e.caretPos+t)}))})),ce.define("dropdown_input",(function(){const e=this
...
e.ignoreHover=!0,r=M(e.activeOption,"[data-group]"),s=B(e.activeOption,"[data-selectable]"),r&&(r=37===i.keyCode?r.previousSibling:r.nextSibling)&&(n=(o=r.querySelectorAll("[data-selectable]"))[Math.min(o.length-1,s)])&&e.setActiveOption(n)}))})),ce.define("remove_button",(function(e){const t=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var i=this
...
return o.appendChild(r),ie(r,"mousedown",(e=>{te(e,!0)})),ie(r,"click",(e=>{i.isLocked||(te(e,!0),i.isLocked||i.shouldDelete([o],e)&&(i.removeItem(o),i.refreshOptions(!1),i.inputState()))})),o}}))}})),ce.define("restore_on_backspace",(function(e){const t=this,i=Object.assign({text:e=>e[t.settings.labelField]},e)
...
var i
c(t)?(i=e.render("loading_more",{query:t}))&&(i.setAttribute("data-selectable",""),o=i):t in r&&!n.querySelector(".no-results")&&(i=e.render("no_more_results",{query:t})),i&&(V(i,e.settings.optionClass),n.append(i))})),e.on("initialize",(()=>{a=Object.keys(e.options),n=e.dropdown_content,e.settings.render=Object.assign({},{loading_more:()=>'<div class="loading-more-results">Loading more results ... </div>',no_more_results:()=>'<div class="no-more-results">No more results</div>'},e.settings.render),n.addEventListener("scroll",(()=>{e.settings.shouldLoadMore.call(e)&&c(e.lastValue)&&(l||(l=!0,e.load.call(e,e.lastValue)))}))}))})),ce}))
