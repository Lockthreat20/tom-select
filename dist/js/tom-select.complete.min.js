...
return e=e.map((e=>(p[e]&&(i+=e.length),p[e]||e))),i>=t?n(e):""})(e,t))))),C=(e,t=!0)=>{let i=e.length>1?1:0
return s(e.map((e=>{let s=[]
const o=t?e.length():e.length()-1
for(let t=0;t<o;t++)s.push(_(e.substrs[t]||"",i))
return n(s)})))},S=(e,t)=>{for(const i of t){if(i.start!=e.start||i.end!=e.end)continue
